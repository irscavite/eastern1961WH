...
function showPage(pageId) {
  ...
  const titles = {
    ...
    addRecordPage: editingKey ? "Edit Equipment Part" : "Add Equipment Parts / Consumables",
    recordsPage: "Equipment Parts / Consumables Summary",
...
function resetForm() {
  ...
  editingKey = "";
  formTitle.textContent = "Add Equipment Parts / Consumables";
  pageTitle.textContent = "Add Equipment Parts / Consumables";
...
if (exportConsumablesBtn) {
  exportConsumablesBtn.addEventListener("click", function () {
    ...
    const headers = ["Item Name", "Last PR Date", "Unit", "Equipment Details / Belongs To", "Remaining Stock"];
